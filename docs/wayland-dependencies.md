...
clipboard/primary byte transfer and cancellation, an available native GTK4
startup smoke, malformed-client isolation, and ten clean compositor lifecycles
under Xvfb or Xephyr.
